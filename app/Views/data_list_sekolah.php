            ...
            <table class="table table-hover table-bordered table-striped" id="rangkuman">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle text-center" scope="col">Total PTK</th>
                        <th rowspan="2" class="align-middle text-center" scope="col">Total ASN</th>
                        ...
                        <tr>
                            ...
                            <?php if (session()->get('role') == 'userLogin') { ?>
                                <td style="text-align: left !important;">
                                    <a href="<?= base_url('data_ptk') ?>?wilayah=<?= trim($row['kode_wilayah']) ?>&npsn=<?= trim($row['npsn']) ?>&level=4"><?= $row['npsn'] ?></a>
                                </td>
                            <?php } else { ?>
