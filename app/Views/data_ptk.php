            ...
            <table class="table table-hover table-bordered table-striped" id="rangkuman">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle text-center wilayah" scope="col">Wilayah</th>
                        <th rowspan="2" class="align-middle text-center total" scope="col">Total PTK</th>
                        <th rowspan="2" class="align-middle text-center total" scope="col">Total PTK ASN</th>
                        <th colspan="2" class="text-center statuskol">Status</th>
                        <th rowspan="2" scope="col" class="text-center khusus">Validitas PTK ASN</th>
                        <th colspan="4" class="text-center">Validitas Data PTK ASN</th>
                    </tr>
                    <tr>
                        <th class="align-middle negeri" scope="col">Negeri</th>
                        <th class="align-middle swasta" scope="col">Swasta</th>
                ...
                <tbody>
                    ...
                    $asn_s = 0;
                    $asn_padan = 0;
                    $asn_padan_nik_valid = 0;
                    $asn_padan_nik_valid_nuptk = 0;
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: left !important;">
                                <a href="<?= base_url('data_ptk') ?>?wilayah=<?= trim($row['kode_wilayah']) ?>&level=<?= $row['id_level_wilayah'] ?>"><?= $row['wilayah'] ?></a>
                            </td>
                            <td><?= $row['total_ptk_aktif'] ?></td>
                            <td><?= $row['asn'] ?></td>
                            <td class="negeri"><?= $row['asn_n'] ?></td>
                            <td class="swasta"><?= $row['asn_s'] ?></td>
